...
if(isset($_GET['nIn'])){
	...
	if(isset($_POST['enc_' . $zeryto12_nIn]) && isset($_POST['pass_' . $zeryto12_nIn])){
		...
		for($zeryto12_i=0; $zeryto12_i <strlen($zeryto12_zmix); $zeryto12_i++){
			...
			for($zeryto12_k=0;$zeryto12_k <count($zeryto11_alph); $zeryto12_k++){
				if($zeryto12_k  == $zeryto12_zmix[$zeryto12_i]){
					$zeryto12_zmix[$zeryto12_i] = $zeryto11_alph[$zeryto12_k];
				}
			}
		}
		echo $zeryto12_zmix; //This contains the z value mix
